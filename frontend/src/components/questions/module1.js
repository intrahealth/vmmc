  ...
  "clientA": {
    ...
    "5": {
      ...
      "choices": [{
        ...
        "comment": "Incorrect. Prophylactic antibiotics are not recommended in VMMC services and given only when there is wound infection.  There is no difference on healing because of his HIV status.  Counsel the client that superficial wound healing will take up to seven days, and complete wound healing is six weeks.",
        "impact": "-2"
      }],
      "nextMove": "clientB",
      "prevMove": 4
  ...
  "clientB": {
    "0": {
      ...
      "choices": [{
        ...
        "comment": "Incorrect. As a  health care provider, provide the client with the correct information for him to make an informed decision and avoid discouraging eligible clients to undergo MC procedure.  Advise the client that it takes up to seven days for superficial healing of the wound. After the seven days, the healing will be advanced, and the client can resume his job and normal activities, but he will need to avoid strenous work or lifting heavy objects which might result to wound disruption.  It takes six weeks for complete wound healing.",
        "impact": "0"
      }],
      "nextMove": 1,
      "prevMove": "clientA"
    ...
    "2": {
      ...
      "choices": [{
        ...
        "comment": "Incorrect. As a health care provider, provide the client with the correct information for him to make an informed decision. During the health education and individual counseling, clients should be informed that although rare but adverse events do occur.  The adverse events which might occur include pain (which increases in severity), bleeding, swelling of the penis and failure to pass urine. The health care provider should use this opportunity to explain to the client that if he experiences one of the adverse events he should return back to the facility/outreach site for further evaluations. The health provider should ensure the emergency contact number is filled in the client appointment card in case of an adverse event.",
        "impact": "-1"
      }, {
        "choiceText": "B. There are risks associated with circumcision, but the chances of these occurring are very rare.",
        "comment": "Incorrect. As a health care provider, provide the client with the correct information for him to make an informed decision. Although the risks associated with circumcision, known as adverse events, rarely occur, clients should be informed that adverse events do occur.  Precautions should be taken.  During the health education and individual counseling, clients should be informed that adverse events which might occur include pain (which increases in severity), bleeding, swelling of the penis and failure to pass urine. The health care provider should use this opportunity to explain to the client that if he experiences one of the adverse events he should return back to the facility/outreach site for further evaluations.  ",
        "impact": "0"
      }, {
    ...
    "4": {
      ...
      "choices": [{
        ...
        "comment": "Incorrect. Not all children are sexually active.  The recommended age for circumcision in the VMMC program is for boys 10 years and older because they have attained their puberty and are considered to be at risk of contracting HIV infection through heterosexual intercourse.",
        "impact": "-1"
      }],
      "nextMove": 5,
      "prevMove": 3
  ...
  "clientC": {
    ...
    "1": {
      ...
      "choices": [{
        ...
        "comment": "Incorrect. It is good to respond with patience. Acknowledge his frustration and work quickly to come up with a solution. As a provider a,ppreciate the fact the teacher took initiative to bring in students for MC. Elaborate on benefits and risks for MC.   Explain the importance of bringing in the parents/guardian for consent and the need proper health education, wound care and post-op follow-up.  Help him understand that by law if he were to take responsibility that would include taking care of students during their recovery and ensuring that they come back for follow up, and he'd be answerable in case anything should happen related to MC.",
        "impact": "0"
      }, {
    ...
    "2": {
      ...
      "choices": [{
        ...
        "comment": "Incorrect. Providing circumcision to the children is not permitted.  MC should only be provided after obtaining consent from parents or guardian.  Take the opportunity to provide health education and counseling to the school children. Talk to them about HIV and STI prevention and explain the circumcision procedure and its benefits so that they are more informed to discuss with their parents. <br><br>Provide them with printed EIC materials to read when they are back home",
        "impact": "-1"
      }, {
    ...
    "5": {
      ...
      "choices": [{
        ...
        "comment": "Incorrect. Reassure the teacher that students undergoing MC will only need to be exempted from heavy duties for first seven days otherwise they can resume to classsrooms as early as three days post MC. Proper schedule can be made to ensure students are not taking advantage of MC to abscond classes.",
        "impact": "-1"
      }, {
